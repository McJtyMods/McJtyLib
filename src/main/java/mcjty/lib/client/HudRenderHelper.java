...
//                        matrixStack.translate(0, 0, -150);
                        ...
                        BakedModel ibakedmodel = itemRender.getModel(stack, Minecraft.getInstance().level, (LivingEntity)null, 0);  // @todo 1.17 check 0
                        itemRender.render(stack, ItemTransforms.TransformType.GUI, false, matrixStack, buffer, 0xf000f0, OverlayTexture.NO_OVERLAY, ibakedmodel);
